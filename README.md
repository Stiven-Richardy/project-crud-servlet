...
Este projeto consiste em uma aplicação web desenvolvida em **Java (Dynamic Web Project)**, utilizando **Servlets** para implementar um sistema básico de CRUD (Create, Read, Update, Delete) para o gerenciamento de funcionários. A aplicação integra formulários HTML com um banco de dados **MySQL** no back-end.
...
| **name** | `VARCHAR(100)` | Sim | Nome do funcionário |
| **password** | `VARCHAR(100)` | Sim | Senha de acesso |
| **email** | `VARCHAR(100)` | Sim | E-mail de contato |
| **country** | `VARCHAR(50)` | Sim | País de origem |
